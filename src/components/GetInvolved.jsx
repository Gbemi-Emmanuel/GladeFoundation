...
const GetInvolved = () => {
    ...
    return(
        <section className="GetInvolved pt-3" id="GetInvloved">
            ...
            <div className="row involvmentButton pt-3">
                <div className="col-md-12">
                    <button data-aos="zoom-in-up" data-toggle="modal" data-target="#donate"><i className="fa-solid fa-heart"></i>Donate Now</button>
                </div>
